...
import Vista.FrmVista2; //Importe El Jframe
...
public class ControladorMDB implements ActionListener{
  ...
  private FrmVista2 _view; //El formulario del Jframe 
  private MDB _model;//el manejador de bases de datos

    
    //public ControladorMDB(FrmVista view, MDB model){
    public ControladorMDB(FrmVista2 view, MDB model){ //Para el formulario del Jframe
       this._model=model;
       this._view=view;
...
this._view.cmdEliminar.addActionListener(this);//se obtiene el control de botón eliminar */
        this._view.comandSubir.addActionListener(this);
        this._view.comandEliminar.addActionListener(this);
}
@Override
...
public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource()==_view.comandSubir){   
        ...
        leyenda=_model.registrarAlta("seguimiento_clientes"," null, "+_view.textCedula.getText()+" ,' "+_view.textExpedicion.getText()+" ',' "+_view.textNombre.getText() +" ',' "+_view.TextProfesion.getText() +" ',' "+_view.TextDResidencia.getText()
                ...
                +_view.textFADos.getText() +" ',' " +_view.textADos.getText() +" ',' "+_view.textFATres.getText() +" ',' "+_view.textATres.getText() +" ',' "+_view.textFACuatro.getText()+" ',' "+_view.textACuatro.getText()+" ' ");
